...
var Juego = {
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 195, 200, 20, 20, 1, { desdeX: 0, hastaX: 500, desdeY: 200, hastaY: 200 }),
    new ZombieCaminante('imagenes/zombie2.png', 765, 750, 20, 20, 1, { desdeX: 0, hastaX: 500, desdeY: 200, hastaY: 200 }),
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (tecla == 'izq') {
    movX = -velocidad;
    if(this.jugador.alto > this.jugador.ancho){
      var aux = this.jugador.alto;
      this.jugador.alto = this.jugador.ancho;
      this.jugador.ancho = aux;
    }
